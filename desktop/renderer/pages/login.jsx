  ...
  return (
    ...
    <div className="flex items-left min-h-screen bg-gray-100 lg:float:left">
        ...
        className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:w-2/4 lg:max-w-screen-xl mt-0 mb-0 ml-0">          <div
                ...
                "Unlock a new level of community safety with our cutting-edge crime-stopping technology !"
                </p>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col space-y-5 z-10 mid:w-2/3" >
                      ...
                      <div className="flex flex-col space-y-5">
                        ...
                        <div className="flex flex-col space-y-4">
                          <a
                            href="#"
                            className="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-[#1F2A38] rounded-md group group hover:bg-[#1F2A38] focus:outline-none"
                          >
                            <span>
                              <svg
