...
<div className="chat chat-end">
  ...
  <div className="chat-bubble chat-bubble-error">I hate you!</div>
  <div className="chat-footer opacity-50">
    Seen at 12:46
  </div>
</div>

            <div className="flex items-center justify-between w-full p-3 border-t border-gray-300 mt-[44rem]">
              <button>
